...
## auteur
[Guénolé Moreau](https://guenolemoreau.fr/)  [@maelle](https://github.com/gueno-m)


## l'expérience
Expérience interactive ou l'utilisateur utilise une manette de ps4 pour contrôler une voiture

## le but
progresser avec l'utilisation de canvas et de node.js

## restitution
on peu voir une capture d'écran de sa partie dans la galerie
